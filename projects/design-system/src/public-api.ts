...
export * from './lib/atoms/multi-select/components/multi-select.component';
export * from './lib/atoms/multi-select/lib-multi-select.module';
...
export * from './lib/atoms/inplace/components/inplace.component';
export * from './lib/atoms/inplace/lib-inplace.module';
...
export * from './lib/atoms/stepper/components/stepper.component';
export * from './lib/atoms/stepper/lib-stepper.module';
